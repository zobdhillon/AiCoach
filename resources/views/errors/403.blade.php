...
<html lang="en">
    ...
    <body
        ...
        <div style="text-align: center; padding: 2rem; max-width: 420px;">
            ...
            <h1 style="font-size: 2rem; font-weight: 800; color: var(--text); margin-bottom: 0.5rem;">403</h1>
            <p style="font-size: 0.95rem; font-weight: 600; color: var(--text-2); margin-bottom: 0.5rem;">Access denied
            </p>
